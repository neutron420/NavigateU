...
interface FacultyRegistrationScreenProps {
  onSubmit: (data: FacultyFormData) => void;
  onBack: () => void;
}

export default function FacultyRegistrationScreen({
  onSubmit,
  onBack,
}: FacultyRegistrationScreenProps) {
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={styles.heading}>Faculty Registration</Text>
...
const styles = StyleSheet.create({
  ...
  pickerOptionSelected: { backgroundColor: "#ECFDF5" },
  pickerOptionText: { fontSize: 15, color: "#475569" },
  pickerOptionTextSelected: { color: "#10B981", fontWeight: "600" },
  submitButton: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  submitButtonDisabled: { backgroundColor: "#6EE7B7", shadowOpacity: 0.1 },
  submitButtonText: {
    fontSize: 16,
    fontWeight: "700",
    color: "#FFFFFF",
